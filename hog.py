...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            numDieRolled = strategy0(score0, score1)
            score0 += take_turn(numDieRolled, score1, dice)
        else:
            numDieRolled = strategy1(score1,score0)
            score1 += take_turn(numDieRolled, score0, dice)
...
def both(f, g):
    ...
    """
    # BEGIN PROBLEM 6
    def f_func(score0, score1):
        a = f(score0, score1)
        b = g(score0, score1)
        def a_func(score0, score1):
            nonlocal f
            nonlocal g
            f = a(score0, score1)
            g = b(score0, score1)
    ...
    def announcer(score0, score1):
        if who:
            if score1 - previous_score > previous_high:
                next_high = score1 - previous_score
                if next_high > 1:
                    print(next_high, "points! That's the biggest gain yet for Player 1")
                else:
                    print(next_high, "point! That's the biggest gain yet for Player 1")
                return announce_highest(who, next_high, score1)
            else:
                return announce_highest(who, previous_high, score1)
        else:
            if score0 - previous_score > previous_high:
                next_high = score0 - previous_score
                if next_high > 1:
                    print(next_high, "points! That's the biggest gain yet for Player 0")
                else:
                    print(next_high, "point! That's the biggest gain yet for Player 0")
                return announce_highest(who, next_high, score0)
            else:
...
def make_averaged(fn, num_samples=1000):
    ...
    def func(*args):
        sum, loop = 0, 0
        while loop < num_samples:
            sum, loop = sum + fn(*args), loop + 1
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for roll in range (1,11):
        ...
        results.append(average_dice(roll, dice))
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if opponent_score %(score+take_turn(0,opponent_score))==0 or take_turn(0,opponent_score) >= margin:
        return 0
    else:
        return num_rolls
